        ...
        <fieldset>
            ...
            <div>
                ...
                <select name="estado" id="estado">
                    <option value="AC" 
                        <?php echo $row['estado'] == "AC"? "selected" : ""?>>Acre
                    </option>
                    <option value="AL"
                        <?php echo $row['estado'] == "AL"? "selected" : ""?>>Alagoas
                    </option>
                    <option value="AP"
                        <?php echo $row['estado'] == "AP"? "selected" : ""?>>Amapá
                    </option>
                    <option value="AM"
                        <?php echo $row['estado'] == "AM"? "selected" : ""?>>Amazonas
                    </option>
                    <option value="BA"
                        <?php echo $row['estado'] == "BA"? "selected" : ""?>>Bahia
                    </option>
                    <option value="CE"
                        <?php echo $row['estado'] == "CE"? "selected" : ""?>>Ceará
                    </option>
                    <option value="DF"
                        <?php echo $row['estado'] == "DF"? "selected" : ""?>>Distrito Federal
                    </option>
                    <option value="ES" 
                        <?php echo $row['estado'] == "ES"? "selected" : ""?>>Espírito Santo
                    </option>
                    <option value="GO"
                        <?php echo $row['estado'] == "GO"? "selected" : ""?>>Goiás
                    </option>
                    <option value="MA"
                        <?php echo $row['estado'] == "MA"? "selected" : ""?>>Maranhão
                    </option>
                    <option value="MT"
                        <?php echo $row['estado'] == "MT"? "selected" : ""?>>Mato Grosso
                    </option>
                    <option value="MS"
                        <?php echo $row['estado'] == "MS"? "selected" : ""?>>Mato Grosso do Sul
                    </option>
                    <option value="MG"
                        <?php echo $row['estado'] == "MG"? "selected" : ""?>>Minas Gerais
                    </option>
                    <option value="PA"
                        <?php echo $row['estado'] == "PA"? "selected" : ""?>>Pará
                    </option>
                    <option value="PB"
                        <?php echo $row['estado'] == "PB"? "selected" : ""?>>Paraíba
                    </option>
                    <option value="PR"
                        <?php echo $row['estado'] == "PR"? "selected" : ""?>>Paraná
                    </option>
                    <option value="PE"
